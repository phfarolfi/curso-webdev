...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()){
        ...
        let div_titulo = document.getElementById('modal-div')
        ...
        div_titulo.className = 'modal-header text-success'
        titulo.textContent = 'Registro Inserido!'
        msg.textContent = 'Despesa cadastrada com sucesso.'
        ...
        div_titulo.className = 'modal-header text-danger'
        titulo.textContent = 'Erro!'
        msg.textContent = 'Preencha todos os dados para adicionar uma despesa.'
